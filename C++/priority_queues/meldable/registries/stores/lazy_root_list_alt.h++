  ...
  namespace thesis {
    namespace root_list {
	 ...
	 lazy_root_list_alt( );
        ...
        void insert_root( iterator_type, N* );
        N* remove_root( iterator_type );
        void concatenate( lazy_root_list_alt& );
        ...
        inline const_iterator_type begin( ) const { return root_list_.begin( ); }
        inline const_iterator_type end( ) const { return root_list_.end( );   }
